...
class GameLoop:
    ...
    def _init_display(self) -> None:
        ...
        if (
            ...
            (
                ...
                self.screen_width,
                self.screen_height
            ) = init_pygame_display(fullscreen=True)
    ...
    def _start_supervised_game(self) -> None:
        ...
        # Ensure supervised model is used
        import os

        # Set environment variable to force supervised model
        os.environ["MODEL_TYPE"] = "numpy"
        # Import here to avoid circular imports
    ...
    def _start_rl_game(self, difficulty: str) -> None:
        ...
        logging.warning(
            f"RL {difficulty} mode not yet implemented, "
            f"falling back to supervised learning."
        )
        self._start_supervised_game()
        self.current_mode = f"play_rl_pretrained_{difficulty}"
    ...
    def _start_rl_learning_game(self) -> None:
        ...
        # For now, fallback to supervised learning
        logging.warning(
            "RL learning mode not yet implemented, "
