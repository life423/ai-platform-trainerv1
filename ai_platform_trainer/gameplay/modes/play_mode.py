...
class PlayMode:
    ...
    def update(self, current_time: int) -> None:
        ...
        if self.game.player:
            ...
            if hasattr(self.game, "screen_width") and hasattr(
        ...
        # 4) Missile AI
        if self.game.missile_model and self.game.player and self.game.player.missiles:
            ...
            for enemy in self.game.enemies:
                ...
                for missile in list(self.game.player.missiles):
                    ...
                    if missile_rect.colliderect(enemy_rect):
                        ...
                        if hasattr(self.game, "renderer") and hasattr(
                            ...
                            logging.debug(
                                f"Created explosion for {getattr(enemy, 'enemy_type', 'enemy')}"
                            )
                        ...
                        if hasattr(self.game, "score"):
                            ...
                            logging.info(
                                f"Score: {self.game.score} (+{score_value} for missile hit)"
                            )
                ...
                for missile in list(self.game.player.missiles):
                    ...
                    if missile_rect.colliderect(enemy_rect):
                        ...
                        if hasattr(self.game, "score"):
                            self.game.score += 100
                            logging.info(
                                f"Score: {self.game.score} (+100 for missile hit)"
                            )
    ...
    def handle_enemy_respawns(self, current_time: int) -> None:
        ...
        for enemy in self.game.enemies:
            ...
            is_respawn_time = (
                current_time >= enemy.respawn_time if has_respawn_time else False
            )
    ...
    def update_time_based_score(self, current_time: int) -> None:
        ...
        if (
            current_time - self.game.last_score_time >= interval
