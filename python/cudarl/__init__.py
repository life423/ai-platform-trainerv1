...
def _setup_module_path():
    """Add the build directory to Python path for CUDA module access."""
...
# Try to set up the module path
_module_path_setup = _setup_module_path()

try:
    # Try to import the compiled C++/CUDA module
    import cudarl_core_python  # noqa: F401
    ...
    print(f"CudaRL-Arena v{VERSION} loaded with CUDA support: "
          f"{CUDA_AVAILABLE}")
